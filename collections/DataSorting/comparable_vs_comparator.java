	...
	-------------------------------------------------------------------------------------------------------------------------------------------																
		...
		2.) by using this we can easily sort String and wrapper     |     2) this is only for user defined class
				classes also we can sort user defined class         |
				  but bit dificult 									|			
				  													|
		3.) it mixing sorting logics and business logics            |     3) here we define sorting logics in a separate class so we can implement 
																	|			when we need 
																	|
		...
		5.) sorting  logic :										|	  5) sorting ologic :
 			 ...
 			 you should override that it needs one obj 				|		   	   you should override that it needs two obj 
 			 														|
 		6.) Colletion.sort(e) (here you pass one arg obj)           |     6)  Colletion.sort(obj,new sortclass()) (here pass obj and create sortclass obj to class)
																	|	
